...
st.set_page_config(page_title="Llama2-doc", page_icon="🤖", layout="wide", )     
st.markdown(f"""
            <style>
...
embeddings = LlamaCppEmbeddings(model_path="models/llama-2-7b.ggmlv3.q4_0.bin")
llm_chain = LLMChain(llm=llm, prompt=prompt)

st.title("Llama2 CPU docQnA")
